...
public class MyProcessEngineConfiguration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MyProcessEngineConfiguration.class);
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) {
        ...
        try {
            ...
            properties.load(this.getClass().getClassLoader().getResourceAsStream("flowable/properties/" + databaseType + ".properties"));
